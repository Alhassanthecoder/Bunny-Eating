...
function setup() {
  ...
  balloon.position(30, 250)
  balloon.mouseClicked(force)

  mute = createImg('mute.png');
  mute.position(430, 50);
  mute.size(50, 50);
  mute.mouseClicked(silent);

  cut2 = createImg('cut_btn.png');
  cut2.position(290, 30);
  cut2.size(50, 50);
  cut2.mouseClicked(drop2);

  cut3 = createImg('cut_btn.png');
  cut3.position(425, 285);
  cut3.size(50, 50);
  ...
  rope2 = new Rope(7, { x: 300, y: 30 })

  rope3 = new Rope(5, { x: 450, y: 300 })
